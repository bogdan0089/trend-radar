from app.services.keywords import overlap, primary_keyword, tokenize
...
class TestTokenize:
    ...
    def test_drops_stopwords(self):
        """'gen', 'with', 'the' є майже в кожній назві — вони нічого не розрізняють."""
...
class TestPrimaryKeyword:
    def test_takes_first_meaningful_words(self):
        """На Amazon спочатку йде бренд і модель, далі — маркетинговий хвіст."""
    ...
    def test_falls_back_to_raw_title_when_all_words_filtered(self):
        """Назва з самих стоп-слів не має давати порожній запит у Google."""
